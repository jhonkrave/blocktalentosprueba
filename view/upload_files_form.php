...
$url = new moodle_url("/blocks/talentospilos/view/upload_files_form.php", array('courseid' => $courseid, 'instanceid' => $blockid));
...
$PAGE->requires->js('/blocks/talentospilos/js/upload.js', true);
$PAGE->requires->js('/blocks/talentospilos/js/upload_files.js', true);

$output = $PAGE->get_renderer('block_talentospilos');

echo $output->header();
//echo $output->standard_head_html(); 
$upload_files_page = new \block_talentospilos\output\upload_files_page('Some text');
