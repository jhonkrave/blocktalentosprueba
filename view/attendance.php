...
$url = new moodle_url("/blocks/talentospilos/view/attendance.php",array('courseid' => $courseid, 'instanceid' => $blockid));
...
$attendance_page = new \block_talentospilos\output\attendance_page('Some text');
