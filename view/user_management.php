...
$url = new moodle_url("/blocks/talentospilos/view/user_management.php", array('courseid' => $courseid, 'instanceid' => $blockid));
...
$PAGE->requires->css('/blocks/talentospilos/style/add_fields.css', true);
...
$PAGE->requires->js('/blocks/talentospilos/js/role_management.js', true);
...
echo $output->header();
$index_page = new \block_talentospilos\output\user_management_page('SomeText');
