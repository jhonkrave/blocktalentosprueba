   ...
   try{
      ...
      if($varSelector == "Municipio")
      {
         ...
         {  
            ...
            if(!$result){
               throw new MyException("Por favor Revisa la liena ".$line_count.".<br>El codigo de División Política del departamento ".$data[1]." asociado al  municipio ".$data[2]." no se encuentra en la base de datos");
            }
      ...
      else if($varSelector == "Usuario")
      {
         ...
         {  
            ...
            if(!$result){
               throw new MyException("Por favor revisa la linea ".$line_count.".<br>NO existe un ususario en moodle para el estudiante estudiante con codigo univalle: ".$data[1]." y programa ".$data[2].". ");
            }
            array_push($temp_array, $result->id);
